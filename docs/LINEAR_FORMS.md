# Linear forms vs grind vs C_-

The a,b ≤ 30 grind is the wrong grain.

Λ = L log 2 − K log 3 is how well a global odd/even count can match log_2 3. Different object from μ_F = log(3/4), which is an expected one-step contraction.
