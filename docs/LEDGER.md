...
| Lemma 1 | every closed orbit, any number of blocks — open |
| Lemma 2 / Lyapunov | descent along paths, including those that never close — open |
| Lemma L | paths reach 1 — needs both empty Δs |

Lemma 1 is still about cycles.
